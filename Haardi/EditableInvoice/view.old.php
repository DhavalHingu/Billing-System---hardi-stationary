...
$(document).ready(function() {
  ...
  $("#addrow").click(function(){
    $(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-wpr"><textarea name="product[]">Item Name</textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div></td><td class="description"><textarea name="inf[]">Description</textarea></td><td><textarea class="cost" name="costt[][]">Rs.0</textarea></td><td><textarea class="qty" name="qtyy[][]">0</textarea></td><td><span class="price">Rs.0</span></td></tr>');
...
<?php
   include "connect.php";
$txt= $_GET['id'];
$result = mysql_query("SELECT * FROM information where no=" . $txt);
...
ff-17,Vishvas City 1,<br>Ghatlodiya,<br>Ahmedabad<br>
		...
		<table id="items" id="tableId">
		  ...
		  <tr class="item-row">
		      ...
		      <td class="description"><textarea name="inf[]"><?php echo$j[0]; ?></textarea></td>
		      <td><textarea class="cost" name="costt[]"><?php echo$k[0]; ?></textarea></td>
		      <td><textarea class="qty" name="qtyy[]"><?php echo$l[0]; ?></textarea></td>
...
<tr class="item-row">
 ...
 <tr class="item-row">
		...
		<input type="submit" name="submit" id="hiderow" value="update" onclick="window.print();">
		<div id="terms">
		  <h5>Terms</h5>
